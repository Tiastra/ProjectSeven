...
<html lang="pt-br">
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-bar w3-large w3-red">
            ...
            <a href="app/views/cliente/clienteAdmin.php" class="w3-bar-item w3-button w3-mobile">Cliente</a>
            <a href="app/views/titulo/tituloAdmin.php" class="w3-bar-item w3-button w3-mobile">Título</a>
        </div>
